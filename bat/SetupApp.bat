...
:: Android packaging
set AND_CERT_NAME="TestProjectStarling"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TestProjectStarling.p12
...
set IOS_PROVISION=cert\TestProjectStarling.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=TestProjectStarling
